! function() {
    ...
    var Iu = function(t) {
            return o(function() {
                return !!hn[t]() || "�떷끷젍" != "�떷끷젍" [t]() || hn[t].name !== t
            })
        },
        Tu = yn.start,
        ku = Iu("trimStart"),
    ...
    var Nu = qt("iterator"),
        Cu = !o(function() {
            ...
            return t.pathname = "c%20d", e.forEach(function(t, n) {
                e.delete("b"), r += n + t
            }), !e.sort || "http://a/c%20d?a=1&c=3" !== t.href || "3" !== e.get("c") || "a=1" !== String(new URLSearchParams("?a=1")) || !e[Nu] || "a" !== new URL("https://a@b").username || "b" !== new URLSearchParams(new URLSearchParams("a=b")).get("a") || "xn--e1aybc" !== new URL("http://�筠��").host || "#%D0%B1" !== new URL("http://a#閨").hash || "a1c3" !== r || "x" !== new URL("http://x", void 0).host
        }),
        Fu = Object.assign,
